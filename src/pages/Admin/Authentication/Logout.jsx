...
function Logout() {
  ...
  const { handleLogOutSubmit, isAdmin, isWareHouser, isHeadTeacher } = useContext(AuthenticationContext);
  ...
  const roleNavigation = () => {
    if (isAdmin()) {
      return <SideNavigation isOpen={isSidebarOpen} toggleSidebar={toggleSidebar} />
    } else if (isHeadTeacher()) {
      return <HeadTeacherNavigation isOpen={isSidebarOpen} toggleSidebar={toggleSidebar} />
    } else if (isWareHouser()) {
      return <WareHouseSideNavigation isOpen={isSidebarOpen} toggleSidebar={toggleSidebar} />
    }
  }
