      ...
      <Routes>
        ...
        <Route element={<PrivateRoute />}>
          ...
          <Route element={<PrivatteWareHouseRoute />}>
            ...
            />
            <Route
              path="/WareHouseGenerateReport"
              element={<WareHouseGenerateReport />}
            />
          ...
          <Route element={<PrivatteHeadTeacherRoute />}>
            <Route path="/" element={<HeadTeacherDashboard />} />
            <Route
              path="/HeaderTeacherInventory"
              element={<HeaderTeacherInventory />}
            />
            <Route
              path="/HeaderTeacherGenerateReport"
              element={<HeaderTeacherGenerateReport />}
            />
            <Route
          ...
          <Route element={<PrivatteQARoute />}>
            ...
            <Route path="/QualityPushNotification" element={<QualityPushNotification />} />
          </Route>
